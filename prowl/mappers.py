...
https://github.com/dioptra-io/diamond-miner/blob/1c9ec96def9b336948678540d93f902dd01c5b5d/diamond_miner/mappers.py

MIT License
https://github.com/dioptra-io/diamond-miner/blob/1c9ec96def9b336948678540d93f902dd01c5b5d/LICENSE
...
from prowl.defaults import DEFAULT_PREFIX_SIZE_V4
...
class IntervalFlowMapper:
    ...
    Examples:
        >>> from prowl.mappers import IntervalFlowMapper
...
class ReverseByteFlowMapper:
    ...
    Examples:
        >>> from prowl.mappers import ReverseByteFlowMapper
...
class RandomFlowMapper:
    ...
    Examples:
        >>> from prowl.mappers import RandomFlowMapper
